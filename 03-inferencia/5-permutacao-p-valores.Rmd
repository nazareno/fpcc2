...
sprintf("Diferença observada nas amostras entre ep 1 e 4: %s", diff.media.observada.1x4)
sprintf("Diferença observada nas amostras entre ep 4 e 5: %s", diff.media.observada.4x5)
```
...
Quando os resíduos do teste chi-quadrado para a associação entre duas categorias for maior que 3.84, rejeitamos a hipótese nula (de não associação) com p < .05.
...
library(vcd)
mosaic(survival ~ sex, data = titanic2)
